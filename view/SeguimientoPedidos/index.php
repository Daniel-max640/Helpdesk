	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podra realizar el seguimiento a los pedidos generados hasta concluir con su facturacion.
				</p>
					...
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								<label class="form-label semibold" for="tick_titulo">Nro Pedido</label>
								<input type="text" class="form-control" id="tick_titulo" name="tick_titulo" placeholder="Ingrese Nro Pedido">
							</fieldset>
						</div>
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								<label class="form-label semibold" for="ped_descrip">Descripción</label>
								<div class="summernote-theme-1">
									<textarea id="ped_descrip" name="ped_descrip" class="summernote" name="name"></textarea>
								</div>
							</fieldset>
						</div>
