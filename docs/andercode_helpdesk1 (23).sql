...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-07-2023 a las 20:11:32
...
INSERT INTO `det_pedido` (`id_detpedido`, `id_pedido`, `id_servicio`, `descripcion`, `u_medida`, `cant_limpieza`, `cantidad`, `precio_uni`, `total`, `descrip_producto`) VALUES
(861, 351, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M3', 1, 4, '250.00', '1000.00', NULL),
(862, 351, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 2, 4, '250.00', '1000.00', NULL),
(863, 351, 4, 'DESATORO DE RED DE DESAGÜE', 'M3', 5, 4, '250.00', '1000.00', NULL),
(864, 352, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(865, 352, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(866, 353, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(867, 353, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(868, 354, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(869, 354, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M2', 5, 1, '250.00', '250.00', NULL),
(870, 355, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(871, 356, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(872, 356, 4, 'DESATORO DE RED DE DESAGÜE', 'M3', 2, 1, '250.00', '250.00', NULL),
(873, 357, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(874, 358, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'UN', 5, 1, '250.00', '250.00', NULL),
(875, 359, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M2', 5, 1, '250.00', '250.00', NULL),
(876, 360, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(877, 361, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(878, 362, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(879, 362, 4, 'DESATORO DE RED DE DESAGÜE', 'M3', 5, 1, '250.00', '250.00', NULL),
(880, 363, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(881, 364, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(882, 365, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(884, 370, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M3', 2, 1, '250.00', '250.00', NULL),
(885, 371, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M2', 2, 1, '250.00', '250.00', NULL),
(886, 372, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(887, 373, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 2, 1, '250.00', '250.00', NULL),
(888, 374, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M3', 5, 1, '250.00', '250.00', NULL),
(889, 375, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(890, 376, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'UN', 5, 1, '250.00', '250.00', NULL),
(891, 377, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M2', 1, 1, '250.00', '250.00', NULL),
(900, 163, 13, 'BAÑO STANDAR / LVM', 'UN', 5, 1, '350.00', '350.00', NULL),
(908, 157, 13, 'BAÑO STANDAR / LVM', 'UN', 1, 2, '350.00', '700.00', NULL),
(909, 157, 14, 'BAÑO STANDAR', 'UN', 2, 2, '350.00', '700.00', NULL),
(913, 392, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(914, 392, 18, 'BAÑO EJECUTIVO', 'UN', 1, 2, '350.00', '700.00', NULL),
(919, 395, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 2, 1, '250.00', '250.00', NULL),
(920, 395, 18, 'BAÑO EJECUTIVO', 'UN', 2, 1, '350.00', '350.00', NULL),
(924, 394, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(925, 394, 18, 'BAÑO EJECUTIVO', 'M3', 4, 1, '350.00', '350.00', NULL),
(933, 379, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 2, 1, '250.00', '250.00', NULL),
(934, 379, 4, 'DESATORO DE RED DE DESAGÜE\n', 'M3', 1, 1, '250.00', '250.00', NULL),
(935, 382, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', NULL),
(936, 382, 18, 'BAÑO EJECUTIVO', 'M3', 4, 1, '350.00', '350.00', NULL),
(941, 380, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M3', 5, 1, '250.00', '250.00', NULL),
(951, 393, 18, 'BAÑO EJECUTIVO', 'M3', 1, 1, '350.00', '350.00', NULL),
(952, 393, 15, 'DUCHA', 'UN', 1, 1, '350.00', '350.00', NULL),
(969, 378, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M2', 4, 1, '250.00', '250.00', NULL),
(970, 378, 4, 'DESATORO DE RED DE DESAGÜE\n', 'M3', 4, 1, '250.00', '250.00', NULL),
(971, 378, 18, 'BAÑO EJECUTIVO', 'UN', 5, 1, '350.00', '350.00', NULL),
(972, 378, 14, 'BAÑO STANDAR', 'UN', 2, 1, '350.00', '350.00', NULL),
(978, 381, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(979, 381, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M3', 5, 1, '250.00', '250.00', NULL),
(980, 381, 4, 'DESATORO DE RED DE DESAGÜE\n', 'M3', 1, 1, '250.00', '250.00', NULL),
(981, 396, 18, 'BAÑO EJECUTIVO', 'M3', 10, 1, '350.00', '350.00', NULL),
(982, 396, 7, 'DESINFECCIÓN', 'M3', 2, 1, '250.00', '250.00', NULL),
(983, 397, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M3', 5, 1, '250.00', '250.00', NULL),
(984, 397, 18, 'BAÑO EJECUTIVO', 'M3', 2, 1, '350.00', '350.00', NULL),
(989, 398, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M3', 2, 1, '250.00', '250.00', NULL),
(990, 398, 18, 'BAÑO EJECUTIVO', 'ML', 5, 1, '350.00', '350.00', NULL),
(993, 399, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(996, 400, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 1, '250.00', '250.00', NULL),
(997, 400, 4, 'DESATORO DE RED DE DESAGÜE\n', 'KG', 1, 1, '250.00', '250.00', NULL),
(1002, 402, 28, 'RECOJO DE RESIDUOS SOLIDOS PELIGROSOS - BIOMEDICOS', 'M3', 5, 1, '250.00', '250.00', NULL),
(1003, 403, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', '<p>ssssss</p>'),
(1004, 403, 7, 'DESINFECCIÓN', 'M2', 2, 3, '250.00', '750.00', '<p>ssss</p>'),
(1005, 403, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'ML', 5, 1, '250.00', '250.00', '<p>sdfsdfs</p>'),
(1006, 403, 3, 'LIMPIEZA DE POZO SÉPTICO', 'M2', 2, 1, '250.00', '250.00', '<p>sdfdfsdf</p>'),
(1007, 404, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'UN', 5, 1, '250.00', '250.00', '<p>sssss</p>'),
(1008, 404, 4, 'DESATORO DE RED DE DESAGÜE', 'M3', 5, 4, '250.00', '1000.00', '<p>sdfsdfdsf</p>'),
(1009, 404, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'ML', 1, 3, '250.00', '750.00', '<p>daniel</p><p><br></p><p><br></p>'),
(1010, 404, 16, 'LAVAMANOS GRANDE', 'M2', 2, 4, '350.00', '1400.00', '<p>lñklñkl</p>'),
(1011, 404, 18, 'BAÑO EJECUTIVO', 'UN', 2, 1, '350.00', '350.00', '<p>sdfsdfsdf</p>'),
(1012, 405, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M3', 5, 4, '250.00', '1000.00', '<p>ghjghj</p>'),
(1013, 405, 2, 'LIMPIEZA DE TRAMPA DE GRASA', 'M3', 2, 3, '250.00', '750.00', '<p>ghghjghj</p>'),
(1014, 405, 18, 'BAÑO EJECUTIVO', 'ML', 2, 4, '350.00', '1400.00', '<p>ghjghj</p>'),
(1015, 405, 14, 'BAÑO STANDAR', 'KG', 5, 3, '350.00', '1050.00', '<p>hjhjkhjk</p>'),
(1016, 405, 3, 'LIMPIEZA DE POZO SÉPTICO', 'M2', 0, 3, '250.00', '750.00', '<p>hjkhjk</p>'),
(1031, 406, 1, 'LIMPIEZA Y DESINFECCIÓN DE CISTERNA DE AGUA', 'M2', 5, 1, '250.00', '250.00', '<p>limpieza m</p>'),
(1032, 406, 2, 'LIMPIEZA DE TRAMPA DE GRASA\n', 'M3', 5, 1, '250.00', '250.00', 'trampa'),
(1033, 406, 18, 'BAÑO EJECUTIVO', 'M3', 5, 1, '350.00', '350.00', 'BAÑO'),
(1034, 406, 7, 'DESINFECCIÓN', 'UN', 5, 1, '250.00', '250.00', '<p>DESINFECCION</p>'),
(1035, 401, 18, 'BAÑO EJECUTIVO', 'KG', 8, 5, '350.00', '1750.00', NULL),
(1036, 401, 15, 'DUCHA', 'UN', 8, 3, '350.00', '1050.00', NULL);
...
(208, 2, '46391315', 'Daniel Moscoso silva', '\"AV. LAS CAMELIAS NRO. 280 (280-290 LAS CAMELIAS) LIMA - LIMA - SAN ISIDRO \"', 3, 15, 127, 1261, '', 'chinacivil@construcction.com', '9978307803', '', '2023-06-07 09:07:31', NULL, NULL, 1, '', '', '', '', '', '', '', '', '');
...
(399, 6, 189, '20100366747', 'AV. EL POLO NRO. 397 (PISO 3 Y 4 ESQ. JR.EMANCIPACION 103 -107) LIMA - LIMA - SANTIAGO DE SURCO', 'LLAMA GAS S A ', '2023-06-28 08:57:23', 'NP01-399', 'SOLES', 2, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 3, 'Mayra Pinglo', 2, '2023-06-02', '250.00', '45.00', '295.00', 'Anulado', '<p>llamar antes de acercarse</p>', 'Luisa Advincula', 'dan.msaj@gmail.com', '997307803', 'Maria Peña', 'elvis.data@sanipperu.com', '963258753', 1, 'coti-0025', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '2', '8-15', 1, 1, 'Anulado', 'OC-452632'),
(400, 15, 188, '20505688902', 'CAL.MIGUEL DASSO NRO. 230 INT. 502 URB. SANTA ISABEL', 'NOMA INMOBILIARIA S.A.C. ', '2023-06-30 08:49:58', 'NP01-400', 'SOLES', 2, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 1, 'Katty Suxe', 1, '2023-06-01', '500.00', '90.00', '590.00', 'Registrado', '<p>dfdgsdfgsdf</p>', 'Luisa Advincula', 'dan.msaj@gmail.com', '997307803', 'Maria Peña', 'elvis.data@sanipperu.com', '963258753', 1, 'coti-0025', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '6', '8-15', 1, 1, 'Pagado', 'OC-452632'),
(401, 15, 189, '20100366747', 'AV. EL POLO NRO. 397 (PISO 3 Y 4 ESQ. JR.EMANCIPACION 103 -107) LIMA - LIMA - SANTIAGO DE SURCO', 'LLAMA GAS S A ', '2023-07-01 10:21:20', 'NP01-401', 'SOLES', 5, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 1, 'Katty Suxe', 2, '2023-07-02', '2800.00', '504.00', '3304.00', 'Registrado', '<p>LLamar antes de acercarse</p>', 'Luisa Advincula', 'dan.msaj@gmail.com', '997307803', 'Maria Peña', 'elvis.data@sanipperu.com', '', 1, '', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '2', '8-15', 1, 1, 'Pendiente', 'OC-112563'),
(402, 15, 190, '20511317038', '\"AV. LAS CAMELIAS NRO. 280 (280-290 LAS CAMELIAS) LIMA - LIMA - SAN ISIDRO \"', 'CHINA CIVIL ENGINEERING CONSTRUCTION CORPORATION SUCURSAL DEL PERU', '2023-06-30 14:47:02', 'NP01-402', 'SOLES', 2, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 1, 'Katty Suxe', 2, '2023-06-02', '250.00', '45.00', '295.00', 'Registrado', '', '', '', '', '', '', '', 1, '', '', '', '', 0, 1, 'Pendiente', 'OC-452632'),
...
(404, 15, 190, '20511317038', '\"AV. LAS CAMELIAS NRO. 280 (280-290 LAS CAMELIAS) LIMA - LIMA - SAN ISIDRO \"', 'CHINA CIVIL ENGINEERING CONSTRUCTION CORPORATION SUCURSAL DEL PERU', '2023-06-30 17:48:03', 'NP01-404', 'SOLES', 1, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 1, 'Katty Suxe', 1, '2023-06-01', '3750.00', '675.00', '4425.00', 'Registrado', '', '', '', '', '', '', '', 1, 'coti-0025', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '2', '16-22', 1, 1, 'Pagado', 'OC-452632'),
(405, 15, 190, '20511317038', '\"AV. LAS CAMELIAS NRO. 280 (280-290 LAS CAMELIAS) LIMA - LIMA - SAN ISIDRO \"', 'CHINA CIVIL ENGINEERING CONSTRUCTION CORPORATION SUCURSAL DEL PERU', '2023-06-30 18:13:01', 'NP01-405', 'SOLES', 2, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 1, 'Katty Suxe', 2, '2023-06-02', '4950.00', '891.00', '5841.00', 'Registrado', '<p>llmaar antes de acercarse</p>', '', '', '', '', '', '', 1, 'coti-0025', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '2', '8-15', 1, 1, 'Pendiente', 'OC-452632'),
(406, 15, 190, '20511317038', '\"AV. LAS CAMELIAS NRO. 280 (280-290 LAS CAMELIAS) LIMA - LIMA - SAN ISIDRO \"', 'CHINA CIVIL ENGINEERING CONSTRUCTION CORPORATION SUCURSAL DEL PERU', '2023-06-30 18:46:24', 'NP01-406', 'SOLES', 3, 'Manuel Dario', '997307803', 'Av. Nicolas Ayllon', 2, 'Katty Suxe', 1, '2023-06-01', '1100.00', '198.00', '1298.00', 'Registrado', '', '', '', '', '', '', '', 1, 'coti-0025', 'http://localhost/Tutorial_Helpdesk-main/view/GenerarPedido/', '2', '8-15', 1, 1, 'Pagado', 'OC-452632');
...
(69, 'Miguel', 'Verastegui Vilva', 'sistemas@sanipperu.com', 'b59c67bf196a4758191e', 1, '2023-05-19 16:30:20', NULL, '2023-06-21 08:52:13', 0),
(70, 'Miguel', 'Verastegui Vilva', 'sistemas@sanipperu.com', 'b59c67bf196a4758191e', 1, '2023-05-19 16:31:12', NULL, '2023-06-21 08:52:24', 0),
...
--
ALTER TABLE `det_pedido`
  MODIFY `id_detpedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1037;
...
--
ALTER TABLE `td_documentoseguimiento`
  MODIFY `id_docseguimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `td_ticketdetalle`
  MODIFY `tickd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
--
ALTER TABLE `tm_cliente`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
...
--
ALTER TABLE `tm_pedido`
  MODIFY `id_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=407;
...
--
ALTER TABLE `tm_ticket`
  MODIFY `tick_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=377;
